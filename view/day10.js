...
import { Image, ImageBackground,StyleSheet,Text,TouchableWithoutFeedback,TouchableHighlight,StatusBar,Animated,Easing,View } from 'react-native';
  ...
  render() {
    return(
      <View style={{backgroundColor:"#37465c"}}>
        ...
        {this.state.show?
        <ImageBackground source={{uri:'tumblrblur'}} style={styles.menu}>
